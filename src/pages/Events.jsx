...
export default function Events() {
  ...
  return (
    <div className="fade-in">
      <style>{`
        .ev-card { background:#ffffff;border:1px solid rgba(148,197,255,0.20);border-radius:4px;padding:20px;display:flex;gap:16px;align-items:flex-start; box-shadow:0 2px 12px rgba(0,0,0,0.12);transition:transform 0.22s,box-shadow 0.22s;position:relative;overflow:hidden; }
        ...
        .ev-title { font-family:'Libre Baskerville',serif;font-size:16px;font-weight:700;color:#0f172a;margin-bottom:7px; }
        .ev-meta  { display:flex;flex-wrap:wrap;gap:10px;margin-bottom:8px; }
        .ev-meta-item { display:flex;align-items:center;gap:4px;font-size:12px;color:#475569; }
        .ev-desc  { font-size:13px;line-height:1.75;color:#0f172a;font-style:italic;border-left:2px solid var(--parch);padding-left:10px; }
        ...
        .section-title::after { content:'';flex:1;height:1px;background:#eff6ff; }
        ...
        .ev-form { background:#ffffff;border:1px solid rgba(148,197,255,0.20);border-radius:4px;padding:22px;margin-bottom:22px;box-shadow:0 4px 16px rgba(0,0,0,0.14);animation:slideDown 0.3s ease both; }
