...
export default function Members() {
  ...
  return (
    <div className="fade-in">
      <style>{`
        .reg-card { background:#ffffff; border:1px solid rgba(148,197,255,0.20); border-radius:4px; padding:20px; position:relative; transition:transform 0.22s,box-shadow 0.22s; box-shadow:0 2px 12px rgba(0,0,0,0.12); overflow:hidden; }
        ...
        .reg-card:hover { transform:translateY(-3px); box-shadow:0 10px 28px rgba(0,0,0,0.22); }
        .reg-card:hover::after { opacity:1; }
        .reg-avatar { width:90px;height:90px;border-radius:50%;flex-shrink:0;overflow:hidden; background:linear-gradient(135deg,var(--amber-dark),var(--amber)); display:flex;align-items:center;justify-content:center; box-shadow:0 3px 14px rgba(124,61,10,0.32); border:3px solid #ffffff; outline:2px solid rgba(212,168,83,0.45); }
        ...
        .reg-name { font-family:'Libre Baskerville',serif;font-size:16px;font-weight:700;color:#0f172a; }
        .reg-meta { display:flex;flex-wrap:wrap;gap:10px;margin-top:6px; }
        .reg-meta-item { display:flex;align-items:center;gap:4px;font-size:12px;color:#475569; }
        .reg-bio { font-size:13px;line-height:1.75;color:#0f172a;font-style:italic; padding-left:12px;border-left:2px solid var(--parch);margin:10px 0; }
